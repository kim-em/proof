...
@[reducible] definition MonoidalCategory.Obj            ( C : MonoidalCategory ) := @Category.Obj            C^.parent
@[reducible] definition MonoidalCategory.Hom            ( C : MonoidalCategory ) := @Category.Hom            C^.parent
@[reducible] definition MonoidalCategory.identity       ( C : MonoidalCategory ) := @Category.identity       C^.parent
@[reducible] definition MonoidalCategory.compose        ( C : MonoidalCategory ) := @Category.compose        C^.parent
@[reducible] definition MonoidalCategory.left_identity  ( C : MonoidalCategory ) := @Category.left_identity  C^.parent
@[reducible] definition MonoidalCategory.right_identity ( C : MonoidalCategory ) := @Category.right_identity C^.parent
@[reducible] definition MonoidalCategory.associativity  ( C : MonoidalCategory ) := @Category.associativity  C^.parent
